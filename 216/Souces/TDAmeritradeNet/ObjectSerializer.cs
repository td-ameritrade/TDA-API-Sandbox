...
// Reference: http://www.codeproject.com/KB/XML/xml_serializationasp.aspx
...
namespace TDAmeritradeNet
{
    ...
    public static class ObjectXMLSerializer<T> where T : class // Specify that T must be a class.
    {
        ...
        public static T LoadXmlString(string xmlString)
        {
        ...
        {
            return SaveToDocumentFormat(serializableObject);
        }

        private static string SaveToDocumentFormat(T serializableObject)
        {
            string res = "";
